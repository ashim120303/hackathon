...
public class Tender {
    ...
    public void setPlannedAmount(String plannedAmount) {this.plannedAmount = plannedAmount;}
    ...
    public String getBidsSubmissionDeadline() {return bidsSubmissionDeadline;}
    public void setBidsSubmissionDeadline(String bidsSubmissionDeadline) {this.bidsSubmissionDeadline = bidsSubmissionDeadline;}
}